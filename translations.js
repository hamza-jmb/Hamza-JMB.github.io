...
const translations = {
    ...
    ar: {
        ...
        projects_coming: " المشاريع الهندسية الرئيسية

• نظام مراقبة الخزانات بتقنية إنترنت الأشياء (IoT): طوّرت نظامًا قائمًا على ESP32 لمراقبة مستوى السوائل في الوقت الفعلي، مع دمجه بمنصة Blynk IoT.

• محاكاة محوّل Synchro إلى إشارات رقمية باستخدام طريقة التكامل لنصف الدورة: طوّرت محاكاة باستخدام MATLAB/Simulink لتحويل الزاوية من نظام Synchro إلى قيمة رقمية، مع تحليل تأثير الضوضاء ودقة القياس.

• مركبة يتم التحكم بها عن بُعد مع نظام كشف العوائق: طوّرت مركبة يتم التحكم بها لاسلكيًا باستخدام ESP32، ومجهزة بمستشعرات القرب لاكتشاف العوائق وقياس المسافات. كما تم استخدام Buzzer ومصابيح LED لإصدار التنبيهات الصوتية والضوئية، بالإضافة إلى التحكم بمحركات DC.

• محاكاة لعبة ثنائية الأبعاد (2D): طوّرت محاكاة تفاعلية ثنائية الأبعاد باستخدام Godot Engine، مع تطبيق الفيزياء في الوقت الفعلي والبرمجة المعتمدة على الأحداث.
 ",
